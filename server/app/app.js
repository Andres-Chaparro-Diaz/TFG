...
app.use(cors({
    //origin: ['https://www.section.io', 'https://gameandreschaparro.vercel.app/'],
...
const emotionalSurvey = require('./routes/emotionalSurvey');
...
app.use('/emotionalSurvey', emotionalSurvey);
app.use('/', indexRouter);
