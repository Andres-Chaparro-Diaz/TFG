...
function _createClass(n, t, e) { return t && _defineProperties(n.prototype, t), e && _defineProperties(n, e), Object.defineProperty(n, "prototype", { writable: !1 }), n }! function(n, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (n = "undefined" != typeof globalThis ? globalThis : n || self).Splide = t() }(this, function() {
    ...
    function Ft(n) { return n = M(n) ? n : n.key, It[n] || n }
    var jt = "keydown";
    var Rt = i + "-lazy",
        Wt = Rt + "-srcset",
        Gt = "[" + Rt + "], [" + Wt + "]";
    ...
    var Bt = Object.freeze({
            ...
            Elements: function(n, t, e) {
                ...
                function v() {
                    i = y("." + ut), o = A(i, "." + st), sn(i && o, "A track/list element is missing."), E(d, S(o, "." + ct + ":not(." + at + ")")), N({ arrows: lt, pagination: vt, prev: pt, next: ht, bar: mt, toggle: yt }, function(n, t) { l[t] = y("." + n) }), T(l, { root: a, track: i, list: o, slides: d }),
                        function() {
                ...
                function y(n) { n = nn(a, n); return n && function(n, t) { if (w(n.closest)) return n.closest(t); for (var e = n; e && 1 === e.nodeType && !B(e, t);) e = e.parentElement; return e }(n, "." + rt) === a ? n : void 0 }

                function b(n) { return [n + "--" + e.type, n + "--" + e.direction, e.drag && n + "--draggable", e.isNavigation && n + "--nav", n === rt && wt] }
                return T(l, { setup: v, mount: function() { s(Mn, g), s(Mn, v), s(zn, m), c(document, kt + " keydown", function(n) { r = "keydown" === n.type }, { capture: !0 }), c(a, "focusin", function() { L(a, Ct, !!r) }) }, destroy: g })
            },
            Slides: function(i, o, r) {
                ...
                return {
                    ...
                    add: function(n, o) {
                        y(n, function(n) {
                            var t, e, i;
                            g(n = M(n) ? Z(n) : n) && ((t = c[o]) ? k(n, t) : P(a, n), C(n, r.classes.slide), n = n, e = D(u, Nn), n = tn(n, "img"), (i = n.length) ? n.forEach(function(n) { s(n, "load error", function() {--i || e() }) }) : e())
                        }), u(Mn)
                    },
                    ...
                    (n = h()) && (function(o) {
                        ...
                        if (u) {
                            ...
                            E(r.slice(-o), r.slice(0, o)).forEach(function(n, t) {
                                var e = t < o,
                                    i = function(n, t) { n = n.cloneNode(!0); return C(n, c.classes.clone), n.id = s.root.id + "-clone" + yn(t + 1), n }(n.slide, t);
            ...
            Move: function(i, s, o) {
                ...
                function x(n, t) { var e = h(f(n - 1) - (e = n, "center" === (n = o.focus) ? (l() - r(e, !0)) / 2 : +n * r(e) || 0)); return t ? function(n) { o.trimSpace && i.is(Dt) && (n = vn(n, 0, h(d() - l()))); return n }(e) : e }

                function _() { var n = p("left"); return Q(v)[n] - Q(g)[n] + h(e(!1)) }

                function C(n) { return x(n ? s.Controller.getEnd() : 0, !!o.trimSpace) }
                return {
                    mount: function() { u = s.Transition, t([En, Tn, zn, Mn], m) },
                    move: function(n, t, e, i) {
                        var o, r;
                        n !== t && (o = e < n, r = h(w(_(), o)), o ? 0 <= r : r <= v[p("scrollWidth")] - Q(g)[p("width")]) && (E(), b(w(_(), e < n), !0)), a(R), c(Sn, t, e, n), u.start(t, function() { a(3), c(xn, t, e, n), i && i() })
                    },
                    jump: y,
                    translate: b,
                    shift: w,
            ...
            Controller: function(r, o, u) {
                ...
                return {
                    ...
                    scroll: function(n, t, e, i) { o.Scroll.scroll(n, t, e, function() { k(x(f.toIndex(l()))), i && i() }) },
                    getNext: g,
                    getPrev: m,
                    getAdjacent: E,
                    getEnd: _,
                    ...
                    toIndex: C,
                    toPage: P,
                    toDest: function(n) { return n = f.toIndex(n), v ? vn(n, 0, _()) : n },
                    hasFocus: L,
                    isBusy: A
                }
            },
            Arrows: function(o, n, t) {
                ...
                function b() {
                    ! function() {
                        ...
                        g && m && (T(y, { prev: g, next: m }), q(v, n ? "" : "none"), C(v, i = lt + "--" + t.direction), n && (u([xn, Mn, In], _), s(m, "click", D(S, ">")), s(g, "click", D(S, "<")), _(), j([g, m], Kn, h.id), c("arrows:mounted", g, m)))
                    }(), u(zn, w)
                }
            ...
            Drag: function(r, i, u) {
                ...
                function D(n) {
                    g.is(6) && (g.set(3), p("dragged")), a && (function(n) {
                        var t = function(n) { if (r.is(Mt) || !P) { var t = T(n); if (t && t < 200) return N(n) / t } return 0 }(n),
                ...
                function j(n) { l = n }
                return { mount: function() { h(w, Lt, G, Ot), h(w, At, G, Ot), h(w, kt, L, Ot), h(w, "click", M, { capture: !0 }), h(w, "dragstart", $), e([En, zn], k) }, disable: j, isDragging: function() { return a } }
            },
            ...
            Pagination: function(f, n, l) {
                ...
                function S() {
                    var n, t = a(r(!0)),
                        e = a(r());
                    t && (en(n = t.button, wt), F(n, Qn), j(n, Un, -1)), e && (C(n = e.button, wt), j(n, Qn, !0), j(n, Un, "")), i("pagination:updated", { list: d, items: y }, t, e)
                }
                return {
                    items: y,
                    mount: function n() {
            ...
            Sync: function(e, n, t) {
                ...
                function u() {
                    var n, t;
                    e.splides.forEach(function(n) { n.isParent || (c(e, n.splide), c(n.splide, e)) }), i && (n = Gn(e), (t = n.on)(Cn, f), t(Dn, l), t([En, zn], a), r.push(n), n.emit(Fn, e.splides))
                }
                ...
                function c(n, i) {
                    n = Gn(n);
                    n.on(Sn, function(n, t, e) { i.go(i.is(Mt) ? e : n) }), r.push(n)
                }
            ...
            Wheel: function(u, s, c) {
                ...
                return { mount: function() { c.wheel && n(s.Elements.track, "wheel", t, Ot) } }
            },
            Live: function(n, t, e) {
                var i = Gn(n).on,
                    o = t.Elements.track,
                ...
                function c(n) { j(o, et, n), n ? (P(o, u), s.start()) : V(u) }

                function a(n) { r && j(o, l, n ? "off" : "polite") }
                return { mount: function() { r && (a(!t.Autoplay.isPaused()), j(o, it, !0), u.textContent = "…", i(jn, D(a, !0)), i(Rn, D(a, !1)), i([xn, In], D(c, !0))) }, disable: a, destroy: function() { F(o, [l, it, et]), V(u) } }
            }
        }),
        Ht = { type: "slide", role: "region", speed: 400, perPage: 1, cloneStatus: !0, arrows: !0, pagination: !0, paginationKeyboard: !0, interval: 5e3, pauseOnHover: !0, pauseOnFocus: !0, resetProgress: !0, easing: "cubic-bezier(0.25, 1, 0.5, 1)", drag: !0, direction: "ltr", trimSpace: !0, focusableNodes: "a, button, textarea, input, select, iframe", live: !0, classes: { slide: ct, clone: at, arrows: lt, arrow: dt, prev: pt, next: ht, pagination: vt, page: gt, spinner: un + "__spinner" }, i18n: { prev: "Previous slide", next: "Next slide", first: "Go to first slide", last: "Go to last slide", slideX: "Go to slide %s", pageX: "Go to page %s", play: "Start autoplay", pause: "Pause autoplay", carousel: "carousel", slide: "slide", select: "Select a slide to show", slideLabel: "%s of %s" }, reducedMotion: { speed: 0, rewindSpeed: 0, autoplay: "pause" } };
    ...
    a = function() {
        function e(n, t) {
            ...
            sn(n, n + " is invalid."), t = O({ label: K(this.root = n, Vn) || "", labelledby: K(n, Zn) || "" }, Ht, e.defaults, t || {});
        ...
        return n.mount = function(n, t) {
            ...
            return sn(i.is([1, 7]), "Already mounted!"), i.set(1), this._C = o, this._T = t || this._T || (this.is(zt) ? Yt : qt), this._E = n || this._E, N(T({}, Bt, this._E, { Transition: this._T }), function(n, t) {
                n = n(e, o, e._o);
                (o[t] = n).setup && n.setup()
            }), N(o, function(n) { n.mount && n.mount() }), this.emit(En), C(this.root, "is-initialized"), i.set(3), this.emit("ready"), this
